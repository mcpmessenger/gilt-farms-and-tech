...
export default function GiltFarmsWebsite() {
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center">
              <div className="h-10 w-10 bg-gradient-to-br from-yellow-400 to-yellow-600 rounded-lg flex items-center justify-center font-bold text-gray-900 text-xl">G</div>
              <span className="ml-3 text-xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 to-yellow-600">Gilt Farms And Tech</span>
            </div>
      ...
      {/* Hero Section */}
      <section id="home" className="pt-24 pb-16 bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center">
            <div className="flex justify-center mb-8">
              <div className="h-32 w-32 md:h-40 md:w-40 bg-gradient-to-br from-yellow-400 via-yellow-500 to-yellow-600 rounded-2xl flex items-center justify-center shadow-2xl transform hover:scale-105 transition">
                <span className="text-5xl md:text-6xl font-bold text-gray-900">G</span>
              </div>
            </div>
            <h1 className="text-4xl md:text-6xl font-bold mb-6">
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 to-yellow-600">Transforming Waste into Wealth</span>
            </h1>
            <p className="text-xl md:text-2xl text-gray-300 mb-8">
              Providing Lasting Solutions for Homes and Agriculture
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a href="#services" className="bg-gradient-to-r from-yellow-500 to-yellow-600 text-gray-900 px-8 py-3 rounded-lg font-semibold hover:from-yellow-400 hover:to-yellow-500 transition shadow-lg">
                Our Services
              </a>
              <a href="#contact" className="bg-transparent text-yellow-400 px-8 py-3 rounded-lg font-semibold border-2 border-yellow-400 hover:bg-yellow-400 hover:text-gray-900 transition">
                Get In Touch
              </a>
            </div>
          </div>
            ...
            <div className="bg-white bg-opacity-10 backdrop-blur-sm p-8 rounded-lg border border-yellow-500 hover:border-yellow-400 transition">
              <div className="flex items-center mb-4">
                ...
                <div>
                  ...
                  <a href="tel:+234906174905" className="text-gray-300 hover:text-yellow-400 transition">
                    +234 906 174 905
                  </a>
                </div>
              </div>
      ...
      <footer className="bg-gray-950 text-white py-8 border-t border-gray-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="flex items-center justify-center mb-4">
            <div className="h-8 w-8 bg-gradient-to-br from-yellow-400 to-yellow-600 rounded-lg flex items-center justify-center font-bold text-gray-900 mr-3">G</div>
